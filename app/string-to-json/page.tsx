...
export default function StringToJson() {
  ...
  const handleConvert = () => {
    ...
    try {
      ...
      // If the string is wrapped in quotes, it might be an escaped JSON string.
      // Try to parse it once.
      let parsed = JSON.parse(currentInput);
      
      // Some strings are double-escaped. Iteratively parse if the result is still a string
      // and looks like it could be JSON (starts with { or [ or is a quoted string)
      let iterations = 0;
      while (typeof parsed === 'string' && iterations < 5) {
        try {
          ...
          // If parsing the string fails, we've reached the deepest level
          break;
        }
      }
    ...
    <div className="mx-auto max-w-7xl px-4 py-12 sm:px-6 lg:px-8">
      <div className="mb-8">
        ...
        <p className="mt-2 text-zinc-600 dark:text-zinc-400">
          Unescape and parse stringified JSON data from logs or code.
        </p>
      </div>
      ...
      <div className="grid gap-6 lg:grid-cols-2">
        <div className="flex flex-col gap-4">
          ...
          <textarea
            ...
            placeholder='Paste your escaped string here... e.g. "{\"a\": 1}"'
        ...
        <div className="flex flex-col gap-4">
          ...
          <div className="relative h-[500px] w-full overflow-hidden rounded-lg border border-zinc-200 bg-zinc-50 dark:border-zinc-800 dark:bg-zinc-950">
            {error ? (
              ...
              <pre className="h-full w-full overflow-auto p-4 font-mono text-sm text-zinc-800 dark:text-zinc-200">
